...
exports.adminReserve = async (req, res) => {
    try {
        ...
        console.log('Getting current admin user ID...');
        ...
        if (adminUserError) {
            console.error("Database error finding admin user:", adminUserError);
            return res.status(500).json({ message: "Database error finding admin user" });
        }
        ...
        const newReservation = {
            ...
            reserved_by: user_name, // Store the name provided by admin
            seat_ID: parseInt(seatNumber),
            seat_num: seat.seat_num // Use the seat_num directly from lab_seats table
            // created_at will be auto-generated by Supabase
        };
